...
const DutchBangla = () => {
    ...
    const handleSubmit = () => {
        if(email ==="" || accountName==="" || accountNumber==="" || contactNumber==="" || contactNumber2===""){
                ...
                <div className="md:px-12 flex justify-center">
                    <div className="w-1/2">
                        ...
                        <div className="mb-3">
                            ...
                            <input onChange={(e)=>dispatch(SetDutchBanglaFormValue({property:"accountName", value:e.target.value}))} value={accountName} className="w-full outline-none border border-gray-400 px-4 py-2 rounded-md" type="text" id="number"/>
                        </div>
                        <div className="mb-3">
                            <label className="block pb-2" htmlFor="number">
                                Account Number
                            </label>
                            <input onChange={(e)=>dispatch(SetDutchBanglaFormValue({property:"accountNumber", value:e.target.value}))} value={accountNumber} className="w-full outline-none border border-gray-400 px-4 py-2 rounded-md" type="text" id="number"/>
                        </div>
                        <div className="mb-3">
                            <label className="block pb-2" htmlFor="contact">
                                Contact Mobile No. 1
                            </label>
                            <input onChange={(e)=>dispatch(SetDutchBanglaFormValue({property:"contactNumber", value:e.target.value}))} value={contactNumber} className="w-full outline-none border border-gray-400 px-4 py-2 rounded-md" type="email" id="contact"/>
                        </div>
                        <div className="mb-3">
                            <label className="block pb-2" htmlFor="contact">
                                Contact Mobile No. 2
                            </label>
                            <input onChange={(e)=>dispatch(SetDutchBanglaFormValue({property:"contactNumber2", value:e.target.value}))} value={contactNumber2} className="w-full outline-none border border-gray-400 px-4 py-2 rounded-md" type="email" id="contact"/>
                        </div>
                    </div>
                </div>
