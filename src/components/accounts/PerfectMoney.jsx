...
import {SetEmail, SetPerfectMoneyFormValue} from "../../redux/features/account/accountSlice.js";
...
const PerfectMoney = () => {
    ...
    const {email, PerfectMoneyFormValue} = useSelector((state)=>state.account);
                ...
                <div className="md:px-12 flex justify-center">
                    <div className="w-3/4 sm:w-1/2">
                        ...
                        <div className="mb-3">
                            ...
                            <input onChange={(e)=>dispatch(SetPerfectMoneyFormValue({property:"perfectUID", value:e.target.value}))} value={perfectUID} className="w-full outline-none border border-gray-400 px-4 py-2 rounded-md" type="text" id="number"/>
                        </div>
                        <div className="mb-3">
                            <label className="block pb-2" htmlFor="contact">
                                Contact Mobile Number.
                            </label>
                            <input onChange={(e)=>dispatch(SetPerfectMoneyFormValue({property:"contactNumber", value:e.target.value}))} value={contactNumber} className="w-full outline-none border border-gray-400 px-4 py-2 rounded-md" type="email" id="contact"/>
                        </div>
                    </div>
                </div>
